...
if __name__ == "__main__":
    ...
    dataset = HYCOM("/home/bailey/dataset/HYCOM/SAB")  # 改
    train_dataset = HYCOM_Train("/home/bailey/dataset/HYCOM/SAB", time=16)  # 改
    ...
    # 加载hpmodel的权重
    hp_save_dict = torch.load("saves/comparison/HYCOM_SAB_hp.pth")
    ...
    for ep in range(epochs):
        ...
        if np.mean(all_losses) < min_loss:
            ...
            utils.save_model(ep=ep + 0, model=hpmodel, model_name=f'comparison/{filename}_ep{ep+81}.pth')  # 改2处