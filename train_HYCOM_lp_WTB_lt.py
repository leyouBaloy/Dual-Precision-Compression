...
num_embeddings = 32
embedding_dim = 32
filename = f"lp_train16"
save_base_path = './saves/ablation/WTB_lt_lp_train16'
...
if __name__ == "__main__":
    ...
    train_dataset = HYCOM_Train("/home/bailey/dataset/HYCOM/WTB_lt", start_time=0, time=16)  # 改
    ...
    #                   commitment_cost=0.25, decay=0.99).to(device)
    # 加载lpmodel的权重
    lp_save_dict = torch.load("saves/ablation/WTB_lt_lp_train16/lp_train16.pth")
