...
if __name__ == "__main__":
    ...
    #                   commitment_cost=0.25, decay=0.99).to(device)
    # 加载lpmodel的权重
    lp_save_dict = torch.load("saves/comparison/HYCOM_SAB_lp.pth")
    ...
    for ep in range(epochs):
        ...
        if np.mean(all_losses) < min_loss:
            ...
            utils.direct_save_model(ep=ep + 0, model=lpmodel, model_name=f'comparison/{filename}.pth')  # 改2处