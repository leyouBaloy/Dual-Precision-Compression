...
n_component = 2
n_prob_sample = 5
filename = f"HYCOM_SEL_lt_hp_ga_part3"
...
if __name__ == "__main__":
    ...
    # 加载lpmodel的权重
    lp_save_dict = torch.load("saves/ablation/HYCOM_SEL_lt_partition/HYCOM_SEL_lt_lp_ga_part3.pth")
    lpmodel.load_state_dict(lp_save_dict['model'])

    # 加载hpmodel的权重
    hp_save_dict = torch.load("saves/ablation/HYCOM_WTB_lt_partition/HYCOM_WTB_lt_hp_ga_part2_ep660.pth")
