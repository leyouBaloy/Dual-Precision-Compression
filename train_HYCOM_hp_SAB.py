...
n_component = 3
n_prob_sample = 5
filename = f"HYCOM_SAB_hp_gmm3"
save_base_path = './saves/comparison/HYCOM_SAB_hp'
...
if __name__ == "__main__":
    ...
    dataset = HYCOM("E:/MarineDatasets/HYCOM/SAB")  # 改
    train_dataset = HYCOM_Train("E:/MarineDatasets/HYCOM/SAB", time=16)  # 改
    ...
    # 加载lpmodel的权重
    lp_save_dict = torch.load("saves/comparison/HYCOM_SAB_lp_ep300.pth")
    lpmodel.load_state_dict(lp_save_dict['model'])

    # 加载hpmodel的权重
    hp_save_dict = torch.load("saves/comparison/HYCOM_SAB_hp/HYCOM_SAB_hp_gmm3_ep290.pth")
