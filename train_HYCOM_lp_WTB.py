...
if __name__ == "__main__":
    ...
    dataset = HYCOM("/home/bailey/dataset/HYCOM/WTB")  # 改
    train_dataset = HYCOM_Train("/home/bailey/dataset/HYCOM/WTB", time=16)  # 改
    ...
    for ep in range(epochs):
        ...
        if np.mean(all_losses) < min_loss:
            ...
            utils.save_model(ep=ep + 0, model=lpmodel, model_name=f'comparison/{filename}.pth')  # 改2处